...
export GRADLE_HOME=/opt/gradle/6.9.4
export TOOL_VERSION=6.9.4
export PROJECT_VERSION=9.2
...
if [ -n "" ]; then
  echo "Creating tag 9.2 to match enforced version"
  git tag -m 9.2 -a 9.2 || true
fi
